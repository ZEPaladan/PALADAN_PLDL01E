...
class Employee:
    ...
    def emp_sss_contribution (self):
        #Conditions for the SSS Contribution
    ...
    def emp_philhealth_contribution(self):
        #Conditions for the PhilHealth Contribution
    ...
    def emp_tax_contribution(self):
        #Conditions for Tax Contribution
        if self.emp_gross_earnings < 10417:
            ...
            self.tax_contribution = ((self.emp_gross_earnings - 83333) * 0.35 + 16770.70)
        else:
    ...
    def emp_displayEmployee(self):
        ...
        print("Gross Income: %.2f" % self.overtime_pay)
